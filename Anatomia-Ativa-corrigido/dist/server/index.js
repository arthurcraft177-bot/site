globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/AnatomyApp-Bpfw5Vdh.js","assets/layout-segment-context-DX93MoN3.js"];
...
function getDraftSecret() {
	return "8511c720-7897-4f8e-8c32-90835bea26a3";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "f2c17835-0072-4160-be11-8a4fef638302";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "f2c17835-0072-4160-be11-8a4fef638302") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "f2c17835-0072-4160-be11-8a4fef638302",
		rootBoundaryId
	});
}
/**
...
var AnatomyApp = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'AnatomyApp' is called on server");
}, "13b8ebb724d1", "AnatomyApp");
//#endregion
//#region app/page.tsx
var page_exports = /* @__PURE__ */ __exportAll({ default: () => Home });
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(AnatomyApp, {});
}
